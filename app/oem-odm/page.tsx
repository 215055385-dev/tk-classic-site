  ...
  return (
    <main className="inner-page oem-page" dir={dir} lang={lang}>
      ...
      <section className="inner-hero section">
        ...
        <p className="inner-hero-lead">{local.heroLead}</p>
