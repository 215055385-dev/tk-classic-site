...
export const metadata: Metadata = {
  ...
  description: "Compare DQ-001 and DQ-010 for US wholesale and private-label sourcing, including coffee formats, controls, samples, customization and quotation steps.",
...
const faqs = [
  ...
  { q: "Which payment methods are supported?", a: "T/T, PayPal and Western Union are supported. The final payment terms are recorded in the formal quotation." },
